	...
	*/
	public void reload() {
		BufferedReader rights = null;
		    try {
		   		URL urlObject = new URL("https://raw.githubusercontent.com/wikimedia-roads/my-bot/master/rights.list");
	...
	*/
	...
	public void checkReassess() {
		BufferedReader result = null;
		    try {
		     	URL urlObject = new URL("https://en.wikipedia.org/w/api.php?action=query&list=categorymembers&cmtitle=Category:U.S._Roads_project_articles_needing_reassessment&format=xml&rawcontinue=yes");
		      	HttpURLConnection connection = (HttpURLConnection) urlObject.openConnection();
		      	InputStream in = connection.getInputStream();
